...
namespace WaterBillingDB
{
    ...
    public partial class ConsumerMaster
    {
        ...
        {
            this.ConsumerMeterMaster = new HashSet<ConsumerMeterMaster>();
            this.DrCrNote = new HashSet<DrCrNote>();
            this.ConsumeDetail = new HashSet<ConsumeDetail>();
        ...
        public Nullable<int> AdjUnit { get; set; }
    
        public virtual ICollection<ConsumerMeterMaster> ConsumerMeterMaster { get; set; }
        public virtual ICollection<DrCrNote> DrCrNote { get; set; }
        public virtual ICollection<ConsumeDetail> ConsumeDetail { get; set; }
